...
function update_player()
 ...
 p.crouching = down and p.on_ground
 ...
 if p.star_throw_t > 0 then
  p.star_throw_t-=1
 end

 if attack_pressed and p.crouching then
  try_throw_star()
 elseif attack_pressed and not attack_active()
...
function solid_plat_at(px,py)
 for pl in all(plats) do
  if pl.room_id==current_room.id then
   local x1=pl.x
   local y1=pl.y
   local x2=x1+pl.w*8-1
   local y2=y1+7
...
function solid_button_at(px,py)
 for b in all(buttons) do
...
function open_room_transition(room_id)
 for d in all(doors) do
  if d.room_id==room_id
  and d.kind=="transition" then
   d.is_open=true
   return
  end
 end
...
--    sfx(01)
 ...
 open_room_transition(b.room_id)
end
   end
   return true
  end
...
elseif it.type=="star" then
 if star_ammo>=max_star_ammo then
  return
 end
 ...
 for r in all(rooms) do
  for yy=0,r.h-1 do
   for xx=0,r.w-1 do
    ...
    if t==imp_r_marker then
     add(enemy_defs,{"imp",r.id,tx,ty,1})
     mset(tx,ty,0)

    elseif t==imp_l_marker then
     add(enemy_defs,{"imp",r.id,tx,ty,-1})
     mset(tx,ty,0)
    end
   end
...

...
0800288444220070087724a44a227770707772488000000000007700708078000055500000550000005000000000000000500000000000000000000000000000
...

...

__label__
...
__gff__

__map__
...

...

...

...

